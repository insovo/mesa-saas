                ...
                <div className="hidden md:flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    <select
                      ...
                      className="h-7 rounded-lg border border-gray-200 px-2 text-[11px] text-navy-700 outline-none focus:border-brand bg-white max-w-[130px]"
                    ...
                    <select
                      ...
                      className="h-7 rounded-lg border border-gray-200 px-2 text-[11px] text-navy-700 outline-none focus:border-brand bg-white max-w-[110px]"
                  ...
                  {c.jdMatch != null ? (
                    ...
                    <div className="w-10 text-[9px] text-gray-400 text-center shrink-0">
